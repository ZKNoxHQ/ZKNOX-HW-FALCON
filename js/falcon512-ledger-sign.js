/* falcon512-ledger-sign.js — Falcon-512 streaming sign client (v0.7.0).
 *
...
const FN_BYTES = 512 * 8;          // 4096
const NODE_MAC_LEN = 16;
const L0_RECORD_SZ = FN_BYTES + NODE_MAC_LEN;       // 4112
const SUBTREE_RECORD_SZ = 26608;
const TOTAL_WIRE_SZ = L0_RECORD_SZ + 2 * SUBTREE_RECORD_SZ;  // 57328
const MSG_BYTES = 32;
const NONCE_BYTES = 40;
const SIG_BYTES = 1024;
