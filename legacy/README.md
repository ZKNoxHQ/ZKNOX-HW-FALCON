> **Archived.** This is the README of ZKNOX-HW-FALCON v0.7.0 (tree-streaming core, INS 0x30..0x34), kept with its
> sources under `legacy/`. It is not built by default any more; `make FALCON_CORE=legacy` still builds it, unmaintained.
> The current implementation is described in the repository README.
